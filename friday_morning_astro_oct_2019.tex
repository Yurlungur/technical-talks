...
\title[LA Astro]{Neutrino Transport and Nucleosynthesis in Post-Merger Disks}
  ...
  \begin{columns}
    \begin{column}{6.5cm}
      ...
      \item How generic are these results?
        \begin{itemize}
        \item Hypermassive NS in center? (Ben)
        \item Neutrino annihilation contributions to the jet (George)
        \item Black Hole-Neutron Star Mergers? (Sanjana)
        \item Initial data? Magnetic field configuration? (Hyun, Valeria)
        \item Connection to other kinds of events, such as collapsars (in prep., Greg)
        \end{itemize}
      \item Physics questions (in prep.):
        \begin{itemize}
        \item What launches the wind?
        \item What macroscopic quantities set electron fraction? Analogue
          of gain time in CCSN?
        \end{itemize}
      \end{itemize}
    \end{column}
    \begin{column}{5.5cm}

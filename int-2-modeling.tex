...
\title[NSM$\nu$]{State of the Art and Future Prospects of Modeling Neutrinos in NS Mergers}
...
\begin{frame}[plain]
  \begin{itemize}
  \item This Document cleared for unlimited release with LA-UR-23-28342
  ...
  \begin{columns}
    \begin{column}{6cm}
      ...
      \item See:
        ...
        \item Coleman Dean's talk this afternoon
        \end{itemize}
      \end{itemize}
    \end{column}
    \begin{column}{6cm}
...
\begin{frame}
  ...
  \begin{itemize}
  \item Neutrino Transport Equation
    \begin{small}
      \begin{displaymath}
...
\begin{frame}
  ...
  \begin{itemize}
  \item $f = \sum_{i=1}^N w_i \delta^3(x - x_i) \delta^3(p - p_i) \delta(t - t_i)$
  \item Error scales as $1/\sqrt{N}$, no matter number of dimensions!
  \end{itemize}
  \begin{columns}
    \begin{column}{5cm}
      \begin{itemize}
      \item Evolve particle paths \textit{deterministically}\\
        $\frac{d^2 x^\mu}{d\lambda^2} + \Gamma^\mu_{\alpha\beta} \frac{d x^\mu}{d\lambda} \frac{d x^\nu}{d \lambda} = 0$
      \item Sample emission/absorption/scattering \textit{probabilistically}\\
        $p(\text{scatt}) \sim \sigma(k^\mu, p_e^\nu)$
      \item Typicall struggles with large optical depths. But much
        recent progress. See, e.g., Foucart et al., PRD 107, 103055 (2023)
      \end{itemize}
    \end{column}
    \begin{column}{7cm}
      \begin{center}
...
\begin{frame}
  \frametitle{Beyond State of the Art: Short Characteristics}
  \begin{columns}
    \begin{column}{6cm}
      \begin{itemize}
      ...
      \item Finite elements discretization (see Maitraya Bhattacharyya this afternoon)
      \end{itemize}
    \end{column}
    \begin{column}{6cm}
      \begin{center}
...
\begin{frame}
  \frametitle{Beyond the State of the Art: Oscillations}
  \begin{columns}
    \begin{column}{6cm}
      \begin{center}
        \includegraphics[width=\columnwidth]{nagakura_boltzmann}
      \end{center}
      {\footnotesize Nagakura, arXiv:2306.10108}
    \end{column}
    \begin{column}{6cm}
      \begin{itemize}
      \item Separation of scales severely limiting: cm length scale for oscillations.
      \item Concerted effort in the community to treat phenomena
        anyway, both microscopically and through increasingly
        sophisticated approximations at macro scale.
      \item See lots of great talks tomorrow.
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  \frametitle{Beyond the State of the Art: Hybrid Methods}
  \begin{itemize}
  ...
  \item Combines advantages of both approximate and exact methods, at
    cost of particles
  \item See, e.g., Foucart, MNRAS \textbf{475} 3 (2018)
  \end{itemize}
  \begin{center}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{6cm}
      \begin{itemize}
      \item Graduate student at MSU: Brandon Barker

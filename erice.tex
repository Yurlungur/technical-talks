...
\title[compact-binaries]{Neutrino Transport and Effects on Observables in Compact Binary Mergers}
% \subtitle{Models and Implications}
\author[J. Miller]{\textcolor{blue}{Jonah M. Miller}, \color{black}in collaboration with:\\
  \color{red}K. Lund, G. McLaughlin\\
...
\date[Erice]{43rd International\\School of Nuclear Physics}
...
\begin{frame}[plain]
  \begin{itemize}
  \item This Document cleared for unlimited release with LA-UR-22-29453

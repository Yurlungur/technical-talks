...
\mode<presentation>
% Time-stamp: <2019-04-03 16:02:27 (jonahm)>
...
\begin{frame}
  \frametitle{Nuclear Astrophysics}
  \begin{columns}
    \begin{column}{6cm}
      \begin{center}
        \includegraphics[width=0.9\columnwidth]
        {The_Sun_by_the_Atmospheric_Imaging_Assembly_of_NASA's_Solar_Dynamics_Observatory.jpg}
      \end{center}
      NASA/HST/SDO/CXC/U. Texas
    \end{column}
    \begin{column}{6cm}
      \begin{center}
        \includegraphics[width=0.9\columnwidth,clip,trim={0 40 0 40}]
        {G299-Remnants-SuperNova-Type1a-20150218}\\
        \vspace{0.25cm}
        \includegraphics[width=0.9\columnwidth]{HST_SN_1987A_20th_anniversary}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \item Nuclear astrophysics:
    \begin{itemize}
    \item Is required to model many import astrophysical transients
    \item Offers insight into our own origins
    \end{itemize}
  \item Neutron star mergers:
    \begin{itemize}
    \item Important site of $r$-process nucleosynthesis
    \item Produce \textit{kilonova}
    \item Need GRRMHD to model!

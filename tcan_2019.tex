...
\title[CNLS smeinar]{Neutrino GRRMHD For Neutron Star Merger Disks with bhlight}
...
\date[15/04/19]{2019 Horizon Meeting}
...
\begin{frame}
  ...
  \begin{center}
    \resizebox{!}{0.9\textheight}{
      \begin{tikzpicture}
        \node at (0,0)
        {\includegraphics[width=\textwidth]{abbot-timeline}};
        \draw[ultra thick,red] (-6,-1.15) rectangle ++(12,1);
      \end{tikzpicture}
    }
  \end{center}
  Abbot+, 2017
...
% \begin{frame}
%   \frametitle{Neutron Star Mergers in Short}
%   \begin{center}

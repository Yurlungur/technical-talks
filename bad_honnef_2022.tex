...
\title[Neutrinos]{Impact of Neutrinos in Post-Merger Accretion Flows}
...
\date[Nov 2022]{WE Heraeus Seminar}
...
\begin{frame}
  ...
  \item Initial conditions matter. What are the right ones? Massive diversity:
    ...
    \end{itemize}
  \item Late time physics. (See M. Shibata's talk.)
  \item Tying different parts of the problem together and
    disentangling uncertainties. (See rest of workshop!)
    \begin{itemize}
    \item Light curve depends on photon opacities and nuclear physics,
      depends on disk and tidal outflows, depends on merger
      params.
    \item Uncertainties between phases of the problem interact.
    \item There are no black boxes!
    \end{itemize}
  \item Neutrino oscillations---Elephant in the room. cm-scale physics impossible to treat.
    \begin{itemize}
    \item Nevertheless, great progress. See work by M.-R. Wu, O. Just, 
      S. Richers, G. McLaughlan, X. Li,  and others.
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \begin{column}{6cm}
      \begin{center}
        \includegraphics[height=0.9\textheight]{tov_fig_paper}
      \end{center}
    \end{column}
  \end{columns}
\end{frame}

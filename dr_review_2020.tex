...
\mode<presentation>
% Time-stamp: <2020-12-02 18:24:27 (jonahm)>
  ...
  \begin{columns}
    \begin{column}{7cm}
      ...
      \item Large diversity in outflows and disk physics
        \begin{itemize}
        % \item from collapsar disks to heavy disks from ``large'' mass
        %   ratio mergers (q $\approx$ 5).
        ...
        % \item There's a sweet spot, around 1\% of a solar mass, where

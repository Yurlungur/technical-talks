...
\begin{frame}
  \frametitle{Disk Drives a Jet}
  \begin{center}
    \animategraphics[width=0.9\textwidth,every=1,autoplay,loop,controls]
    {10}{gw170817disk_rho_frames/frame_}{0001}{0837}
  \end{center}
  \textbf{JMM}+, in prep.
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \animategraphics[height=0.475\textheight,every=1,autoplay,loop,controls=off]
